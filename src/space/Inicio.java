...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registro2 = new space.Registro();
        login2 = new space.login();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        login.addTab("Registro", registro2);
        login.addTab("Login", login2);
    ...
    private space.login login2;
    private space.Registro registro2;
